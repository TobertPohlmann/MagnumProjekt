...
public static class Gerichte
{
    ...
    private static void SchreibeAlleGerichteSortiertNach(Func<Gericht, double> sortierFunktion, bool aufsteigend)
    {
    ...
    public static void SchreibeAlleGerichte(Nährwert sortiertNach = Nährwert.Brennwert, bool aufsteigend = false)
    {
        ...
        SchreibeAlleGerichteSortiertNach(sortierFunktion, aufsteigend);
    }
}